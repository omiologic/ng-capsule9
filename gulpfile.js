...
gulp.task('copy:source', function () {
  ...
  //   return gulp.src([`${srcFolder}/${PACKAGE}/**/*`, `!${srcFolder}/node_modules`])
  //     .pipe(gulp.dest(`${tmpFolder}/${PACKAGE}`));
  // })
...
gulp.task('tsc', function () {
  ...
  //   ngc([ '--project', `${tmpFolder}/${PACKAGE}/tsconfig-build.json` ]);
  //   return Promise.resolve();
  // }));
  // ngc([ '--project', `${tmpFolder}/tsconfig.es5.json` ]);

  shell.exec(`tsc -p ${tmpFolder}/ajax/tsconfig-build.json`)
  return Promise.resolve();
});
...
gulp.task('rollup:fesm', function () {
  return gulp.src(`${distFolder}/packages/**/*.js`)
  // transform the files here.
    .pipe(rollup({

      // Bundle's entry point
      // See "input" in https://rollupjs.org/#core-functionality
      input: `${distFolder}/packages/ajax/src/ajax.js`,
